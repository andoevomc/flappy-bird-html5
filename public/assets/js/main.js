...
var mainState = {
	...
	create: function() {
        ...
        this.score = 0;
        this.labelHighScore = game.add.text(15, 15, "High score: " + highScore, fontStyleScore);
        this.labelScore = game.add.text(15, 50, "Score: 0", fontStyleScore);
	...
	update: function() {
        ...
        if(this.scorePipe != null && this.scorePipe.body.x <= 100) {
            ...
            if(this.score > highScore) {
                ...
                this.labelHighScore.text = "High score: " + highScore;
            }
            this.scorePipe = null;
